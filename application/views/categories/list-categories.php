...
<div class="container">
	...
	<input type="search" name="search-category" id="search-category" placeholder="  Search category..." class="form-control form-control-sm w-25 ml-auto font-weight-bold mb-2" />
