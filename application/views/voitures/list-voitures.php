	...
	<table class="table table-bordered table-hover table-sm mb-5">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center"><img src="<?php echo base_url('public/uploads/' . $voiture['image'] ); ?>" alt="<?php echo $voiture['marque'] . '-' . $voiture['numero']; ?>" title="<?php echo $voiture['marque'] . '-' . $voiture['numero']; ?>" width="111" loading="lazy" /></td>
